...
export defaults class TableList extends React.Component {
  ...
  handleSort(key) {
    ...
    this.setState(newState, () => {
      this.props.actions.objectListSort({
        field: key,
        order: this.state.sortOrder ? 'asc' : 'desc'
      });
    });
  }

  componentDidMount() {
    this.refreshManualReorder();
  }
  ...
  handleLoadMore() {
    this.props.actions.objectListLoadMore();
  }
